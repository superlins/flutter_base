...
abstract class AppLocalizations {
  ...
  /// No description provided for @error_moderation.
  ///
  /// In en, this message translates to:
  /// **'Content violation: {reason}'**
  String error_moderation(String reason);

  /// No description provided for @moderation_default_reason.
  ///
  /// In en, this message translates to:
  /// **'unacceptable content'**
  String get moderation_default_reason;
  ...
  ///
  /// In en, this message translates to:
  /// **'A consistent, clean, and modern UI template for both iOS and Android.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Perfectly balanced aesthetics'**
  String get home_card_subtitle;

  /// No description provided for @home_explore.
  ///
  /// In en, this message translates to:
  /// **'Start Exploring'**
  String get home_explore;

  /// No description provided for @home_components_title.
  ///
  /// In en, this message translates to:
  /// **'Common Components'**
  String get home_components_title;
